<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Client/MasterPageCitizen.master" CodeFile="ElectricityComplaints.aspx.cs" Inherits="Client_ElectricityComplaints" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <div class="animated bounceIn" >
        <h1 class="auto-style5"><em>Register Electricity Complaint</em></h1>
        <br />
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="txtName" runat="server"  class="txtBox" placeholder="Please Enter The Full Name.."  Width="301px" ></asp:TextBox>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="txtComplaintMessage" runat="server"  class="txtBox" placeholder="Please Enter the full Discreption of complaint.."  Height="50px" TextMode="MultiLine" Width="301px"></asp:TextBox>
                </td>
            </tr>
             <tr>
