...
public partial class Client_GarbageComplaints : System.Web.UI.Page
{
    ...
    protected void BtnRegister_Click(object sender, EventArgs e)
    {
        ...
        String query = "insert into GarbageComplaints(complaintId,Registerdatetime,Cname,Complaintsdetails,ComplaintAddress,CompalintImage,Status,RegistrationId) values(" + complaintid + ",'" + Label2.Text + "','" + txtName.Text + "','" + txtComplaintMessage.Text + "','" + txtAddress.Text + "','" + Link + "','Under Processing','" + regId + "')";
      //  String mycon = @"Data Source=DELL\SQLEXPRESS;Initial Catalog=CRWA;Integrated Security=True";
       // SqlConnection con = new SqlConnection(mycon);
       // con.Open();
       ...
       // String s = "Welcome \n Your Complaint About Garbage Is Registered Sucessfuly !!!\n Below are the details\n\n\n ";
    ...
    public void getcomplaintid()
    {
        ...
        String myquery = "select complaintId from GarbageComplaints";
        SqlCommand cmd = new SqlCommand();
        ...
        else
        {
            ...
            String myquery1 = "select max(complaintId) from GarbageComplaints";
