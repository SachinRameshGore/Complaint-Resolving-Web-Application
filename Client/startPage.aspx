<%@ Page Language="C#" AutoEventWireup="true" CodeFile="startPage.aspx.cs" Inherits="Client_startPage" %>
...
<body>
    ...
    <div class="content">
    <h1 class="auto-style3">Complaint Resolving Web Application</h1>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style6">
                    <asp:HyperLink ID="HyperLink4" runat="server" CssClass="auto-style2"  ForeColor="White" NavigateUrl="~/user/video1.aspx">VIDEOS</asp:HyperLink>
                </td>
                <td>&nbsp;</td>
    ...
    <asp:Panel ID="panel1" runat="server" class="login" >
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="TxtPassword" ForeColor="Red" Font-Size="X-Large"></asp:RequiredFieldValidator>
                   ...
                   <div class="auto-style3">
                       ...
                       <asp:Button ID="btnlogin" runat="server" class="login-button" text="LOGIN" width="120px" OnClick="btnlogin_Click" />
                       <br />
                       <br />
                   
                       <a href="CitizenRegistration.aspx">New Registration</a>
            </div>
