...
public partial class Client_WaterComplaint : System.Web.UI.Page
{
    ...
    protected void BtnRegister_Click(object sender, EventArgs e)
    {
        ...
        String query = "insert into WaterComplaint(complaintId,Registerdatetime,Cname,Complaintsdetails,ComplaintAddress,CompalintImage,Status,RegistrationId) values(" + complaintid + ",'" + Label2.Text + "','" + txtName.Text + "','" + txtComplaintMessage.Text + "','" + txtAddress.Text + "','" + Link + "','Under Processing','" + regId + "')";
        // SqlConnection con = new SqlConnection(mycon);
       // con.Open();
        ...
        //String s = "Welcome \n Your Complaint About Water Is Registered Sucessfuly !!!\n Below are the details\n\n\n ";
    ...
    public void getcomplaintid()
    {
        ...
        String myquery = "select complaintId from WaterComplaint";
        SqlCommand cmd = new SqlCommand();
        ...
        else
        {
            ...
            String myquery1 = "select max(complaintId) from WaterComplaint";
