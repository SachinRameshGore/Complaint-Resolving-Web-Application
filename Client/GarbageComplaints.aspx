<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Client/MasterPageCitizen.master" CodeFile="GarbageComplaints.aspx.cs" Inherits="Client_GarbageComplaints" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <br/> 
     ...
     <div class="animated bounceIn" >
        <h1 class="auto-style5"><em>Register Garbage Complaint</em></h1>
        <br />
