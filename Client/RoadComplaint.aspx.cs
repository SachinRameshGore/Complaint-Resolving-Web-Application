...
public partial class Client_RoadComplaint : System.Web.UI.Page
{
    ...
    {
        //String s1 = Session["user"].ToString()0;
        ...
        String Link = "images/" + Path.GetFileName(FileUpload1.FileName);//incomplete path

        String query = "insert into RoadComplaint(complaintId,Registerdatetime,Cname,Complaintsdetails,ComplaintAddress,CompalintImage,Status) values(" + complaintid + ",'" + Label2.Text + "','" + txtName.Text + "','" + txtComplaintMessage.Text + "','" + txtAddress.Text + "','" + Link + "','Under Processing')";
     //   SqlConnection con = new SqlConnection(mycon);
  //      con.Open();
        ...
        cmd.Connection = con;
        cmd.ExecuteNonQuery();
        //CopyFiles( @"C:\Users\DELL 123\Documents\Visual Studio 2012\WebSites\CRA\images",@"C:\Users\DELL 123\Documents\Visual Studio 2012\WebSites\CRA\Admin\images");
      
        Label3.Text = "Your Complaint ID is " + complaintid + " . You can Check the Status of Complaint Using Complaint ID";


        //String s = "Welcome \n Your Complaint About Road Is Registered Sucessfuly !!!\n Below are the details\n\n\n ";
    ...
    public void getcomplaintid()
    {
        ...
        String myquery = "select complaintId from RoadComplaint";
        SqlCommand cmd = new SqlCommand();
        ...
        else
        {
            ...
            String myquery1 = "select max(complaintId) from RoadComplaint";
