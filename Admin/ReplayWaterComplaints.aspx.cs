...
public partial class Admin_ReplayWaterComplaints : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["complaintId"] != null)
        {
            ...
            String myquery = "Select * from WaterComplaint where complaintId=" + complaintid;
    ...
    {
        String mycon = @"Data Source=DELL\SQLEXPRESS;Initial Catalog=CRWA;Integrated Security=True";
        String updatedata = "Update WaterComplaint set Status='Processed'" + ", Replaying='" + TxtReplay.Text + "' where complaintId=" + Complaintid.Text;
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
