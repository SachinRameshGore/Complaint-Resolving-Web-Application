<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master"   AutoEventWireup="true" CodeFile="ViewElectricalServiceMans.aspx.cs" Inherits="Admin_ViewElectricalServiceMans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div  class="backelectricty">
        <h1 class="auto-style9"><em>Eletircal Serviceman</em></h1>
   ...
   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999"  Height="30px" Width="1010px"  BorderStyle="Solid" BorderWidth="3px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" CellSpacing="2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CRWAConnectionString %>"
             SelectCommand="SELECT * FROM [ElectricityServiceMan]" DeleteCommand="DELETE FROM [ElectricityServiceMan] WHERE [Id] = @Id" InsertCommand="INSERT INTO [ElectricityServiceMan] ([Name], [Birthdate], [Age], [Address], [workarea], [EmailId], [MobileNo], [AadharCardNo]) VALUES (@Name, @Birthdate, @Age, @Address, @workarea, @EmailId, @MobileNo, @AadharCardNo)" UpdateCommand="UPDATE [ElectricityServiceMan] SET [Name] = @Name, [Birthdate] = @Birthdate, [Age] = @Age, [Address] = @Address, [workarea] = @workarea, [EmailId] = @EmailId, [MobileNo] = @MobileNo, [AadharCardNo] = @AadharCardNo WHERE [Id] = @Id">
            <DeleteParameters>
