...
public partial class Admin_ReplayGarbageComplaints : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["complaintId"] != null)
        {
            ...
            String myquery = "Select * from GarbageComplaints where complaintId=" + complaintid;
            ...
            {
                Response.Redirect("ViewGarbageComplaints.aspx");
    ...
    {
        String mycon = @"Data Source=DELL\SQLEXPRESS;Initial Catalog=CRWA;Integrated Security=True";
        String updatedata = "Update GarbageComplaints set Status='Processed'" + ", Replaying='" + TxtReplay.Text + "' where complaintId=" + Complaintid.Text;
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
